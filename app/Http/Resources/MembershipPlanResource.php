...
final class MembershipPlanResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'allowed_time_start' => $this->allowed_time_start ? $this->allowed_time_start->format('H:i') : null,
            'allowed_time_end' => $this->allowed_time_end ? $this->allowed_time_end->format('H:i') : null,
